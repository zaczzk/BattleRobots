...
{
    [CreateAssetMenu(menuName = "BattleRobots/Arena/ZoneControlCaptureInductor", order = 320)]
    public sealed class ZoneControlCaptureInductorSO : ScriptableObject
    {
        [Header("Config")]
        [SerializeField, Min(1)] private int _turnsNeeded       = 5;
        [SerializeField, Min(1)] private int _fluxPerBot        = 1;
        [SerializeField, Min(0)] private int _bonusPerInduction = 1540;
